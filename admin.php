                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-12">
                                <div class="d-flex gap-3 search-jb">
                                    ...
                                    <div class="position-relative">
                                        <input type="search" placeholder="Applicants" name="title" id="">
                                        <i class="fa-solid fa-id-card-clip"></i>
                                    </div>
                                    <div class="position-relative">
                                        <input type="search" placeholder="Reviewed" name="location" id="">
                                        <i class="fa-light fa-eye"></i>
                                    </div>
                                    <div class="position-relative">
                                        <input type="search" placeholder="Awaiting Review" name="location" id="">
