                    ...
                    <ul>
                        ...
                        <li>
                            <div class="select-dropdown">
                                ...
                                <ul class="select-dropdown__list ">
                                    <li data-value="1" class="select-dropdown__list-item"><a href="about.php">Any time</a></li>
                                    <li data-value="2" class="select-dropdown__list-item"><a
                                            href="comunity.php">Past month</a>
                                    </li>
                                    <li data-value="3" class="select-dropdown__list-item"><a
                                            href="members.php">Past week</a>
                                    </li>
                                    <li data-value="4" class="select-dropdown__list-item"><a
                                            href="merchandise.php">Past 24 hours</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li>
                            <div class="select-dropdown">
                                ...
                                <ul class="select-dropdown__list ">
                                    ...
                                    <li data-value="13" class="select-dropdown__list-item"><a
                                            href="members.php">Show results</a>
                                    </li>
                        ...
                        <li>
                            <div class="select-dropdown">
                                ...
                                <ul class="select-dropdown__list ">
                                    <li data-value="31" class="select-dropdown__list-item"><a href="about.php">About
                                            Us</a></li>
